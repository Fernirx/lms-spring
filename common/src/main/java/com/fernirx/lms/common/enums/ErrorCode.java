...
public enum ErrorCode {
    ...
    MISSING_REQUEST_PARAMETER("MISSING_REQUEST_PARAMETER", HttpStatus.BAD_REQUEST),
    ENDPOINT_NOT_FOUND("ENDPOINT_NOT_FOUND", HttpStatus.NOT_FOUND),
    HTTP_METHOD_NOT_ALLOWED("HTTP_METHOD_NOT_ALLOWED", HttpStatus.METHOD_NOT_ALLOWED),
    ...
    // ========== OTP ERRORS (400/401/429) ==========
    OTP_EXPIRED("OTP_EXPIRED", HttpStatus.BAD_REQUEST),
    OTP_NOT_FOUND("OTP_NOT_FOUND", HttpStatus.NOT_FOUND),
    OTP_MAX_ATTEMPTS_EXCEED("OTP_MAX_ATTEMPTS_EXCEED", HttpStatus.BAD_REQUEST),
    OTP_INVALID("OTP_INVALID", HttpStatus.BAD_REQUEST),
    OTP_MAX_RESEND_EXCEEDED("OTP_MAX_RESEND_EXCEEDED", HttpStatus.TOO_MANY_REQUESTS),
    OTP_RESEND_COOLDOWN_EXCEEDED("OTP_RESEND_COOLDOWN_EXCEEDED", HttpStatus.TOO_MANY_REQUESTS),
